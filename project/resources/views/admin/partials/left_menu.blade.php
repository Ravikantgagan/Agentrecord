<ul class="sidebar navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="{{ url ( 'ADshboard' )}}">
...
<!--
        <li class="nav-item">
          <a class="nav-link" href="{{url('admin-agent-form')}}">
            <i class="fas fa-fw fa-user-circle"></i>
...
-->
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(5px, 56px, 0px);">
             <a class="dropdown-item" href="{{ url('agent/add') }}">Register Agent</a>
            <a class="dropdown-item" href="{{url('agentshow')}}">All Agents</a>
